...
DROP POLICY IF EXISTS "Activities are viewable by group members" ON activities;
DROP POLICY IF EXISTS "Group members can create activities" ON activities;
DROP POLICY IF EXISTS "Activity creators can update activities" ON activities;
DROP POLICY IF EXISTS "Activity creators can delete activities" ON activities;
DROP POLICY IF EXISTS "Activity participants are viewable by group members" ON activity_participants;
DROP POLICY IF EXISTS "Group members can manage their participation" ON activity_participants;
DROP POLICY IF EXISTS "Items are viewable by group members" ON items;
DROP POLICY IF EXISTS "Group members can manage items" ON items;
DROP POLICY IF EXISTS "Templates are viewable by group members" ON member_templates;
DROP POLICY IF EXISTS "Group members can create templates" ON member_templates;
DROP POLICY IF EXISTS "Template creators can update templates" ON member_templates;
DROP POLICY IF EXISTS "Template creators can delete templates" ON member_templates;
DROP POLICY IF EXISTS "Template members are viewable by group members" ON template_members;
DROP POLICY IF EXISTS "Template creators can manage template members" ON template_members;
DROP POLICY IF EXISTS "Messages are viewable by group members" ON messages;
...
-- メッセージのリアルタイム更新を有効化（既に有効な場合はエラーが出ますが問題ありません）
